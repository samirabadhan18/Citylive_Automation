...
public class WALLET_Multiple extends BaseTest {
    ...
    public static void LoginTest(String username, String password) throws InterruptedException, IOException, AWTException {
        ...
        */
        ...
        Thread.sleep(8000);
        driver.findElement(By.cssSelector(loc.getProperty("cbl_walt"))).click();
        Thread.sleep(10000);
        Actions action = new Actions(driver);
        action.sendKeys(Keys.PAGE_DOWN).perform();
        driver.findElement(By.cssSelector(loc.getProperty("mltpl"))).click();
        Thread.sleep(10000);
        driver.findElement(By.xpath(loc.getProperty("cbl_wllt_mltpl_cmp_drp"))).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath(loc.getProperty("cbl_wllt_mltpl_cmp_slct"))).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath(loc.getProperty("cbl_wllt_payment_mltpl_fl_upld"))).sendKeys("D:\\City Live\\Data_Driven_Project\\wallet-upload-sample-file.xls");
        Thread.sleep(8000);
        driver.findElement(By.xpath(loc.getProperty("cbl_wllt_payment_mltpl_xl_upld"))).click();
        Thread.sleep(8000);
        driver.findElement(By.xpath(loc.getProperty("cbl_WLLT_payment_mltpl_trnsc_cnfrm"))).click();
        Thread.sleep(40000);

// --- "CBL WALLET Multiple Payment Signatory Confirm" ---

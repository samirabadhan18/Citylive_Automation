...
public class RTGS_Single_Non_Ben  extends BaseTest {
...
// --- "CBL RTGS Single Payment with ADD Beneficiary" ---
        ...
        Thread.sleep(5000);
        driver.findElement(xpath(loc.getProperty("cbl_RTGS_trnsfr_type_radio_btn_nonBen"))).click();
        Thread.sleep(3000);

        // --- "CBL RTGS Payment Non Ben ACC Name ACC Num Email Bank Name,Branch " ---
        driver.findElement(By.xpath(loc.getProperty("cbl_RTGS_nonBen_name"))).sendKeys(loc.getProperty("cbl_RTGS_nonBen_name_value"));
        Thread.sleep(1000);

        driver.findElement(By.xpath(loc.getProperty("cbl_RTGS_nonBen_ACC_Num"))).sendKeys(loc.getProperty("cbl_RTGS_nonBen_ACC_Num_value"));
        Thread.sleep(3000);

        driver.findElement(By.xpath(loc.getProperty("cbl_RTGS_nonBen_routing_num"))).sendKeys(loc.getProperty("cbl_RTGS_nonBen_routing_num_value"));
        Thread.sleep(3000);

//        driver.findElement(By.xpath(loc.getProperty("cbl_RTGS_nonBen_Bank_name"))).sendKeys(loc.getProperty("cbl_RTGS_nonBen_Bank_name_value"));
//        Thread.sleep(3000);

        driver.findElement(By.xpath(loc.getProperty("cbl_RTGS_nonBen_email"))).sendKeys(loc.getProperty("cbl_RTGS_nonBen_email_value"));
        Thread.sleep(1000);
